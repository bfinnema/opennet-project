...
# ------------------------
# Provisioning of an OpenNET Subscriber using EVPN-VPWS between POI and PE.
# Initial revision by Bo Finnemann, April 4 2020
# ------------------------
class ServiceCallbacks(Service):
    ...
    def cb_create(self, tctx, root, service, proplist):
        ...
        for vlan in service.vlans.vlan:
            ...
            template.apply('newSubPE_EV-template', vars)
...
class Main(ncs.application.Application):
    def setup(self):
        ...
        #
        self.register_service('newSubPE_EV-servicepoint', ServiceCallbacks)
